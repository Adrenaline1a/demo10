...
def cylinder():
    ...
    def circle():
        print('Площадь полной поверхности цилиндра: ', 2 * 3.14 * radius * height + 2 * 3.14 * radius ** 2)

    message = input('Какую площать вы хотите получить: площадь бокой поверхности или полную площадь цилиндра?\n'
